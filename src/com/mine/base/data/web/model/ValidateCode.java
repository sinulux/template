...
public class ValidateCode {
	...
	private char[] codeSequence = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J',
			...
			'X', 'Y', 'Z',  '1', '2', '3', '4', '5', '6', '7', '8', '9','a','b','c','d','e','f','g','h','i','j',
			'k','l','m','l','p','q','r','s','t','u','v','w','x','y','z'};
	 ...
	 * 简单粗暴验证码
	 */
	public void simpleCode(HttpServletRequest request, HttpServletResponse response)
	...
	private String getNumber(int size) {
		//字符集
		String str = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnobqrstuvwxyz0123456789";
		String number = "";
		Random r = new Random();
	 ...
	 * 方式3
	 */
	public void otherCode(HttpServletRequest request, HttpServletResponse response)
    	throws ServletException, IOException {
