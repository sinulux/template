	...
	var floatFun = function() {
		...
		this.container = function() {
			...
			if (cont == "plugin") {
				...
				cont = $('<div id="floatBox_' + mode + random + '" class="float_' + mode + '_box"></div>');
		...
		this.createSharp = function(dir) {
			...
			if (!this.corner || null == this.corner) {
				...
				var html = '<div id="floatCorner_' + dir + random + '" class="float_corner float_corner_' + dir + '">' + '<span class="corner corner_1" ' + color1 + '>◆</span>' + '<span class="corner corner_2" ' + color2 + '>◆</span>' + '</div>';
				$("body").append($(html));
